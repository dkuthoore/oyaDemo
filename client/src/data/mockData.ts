...
export const mockInsights: Insight[] = [
  ...
  },
  {
    ...
    content:
      "Understanding private keys, seed phrases, and cold storage for maximum security.",
    category: "Security",
  ...
  },
  {
    ...
    content:
      "Layer 2 solutions like Optimism and Arbitrum reduce gas fees and improve transaction speed.",
    category: "Layer 2",
...
export const mockLessons: Lesson[] = [
  {
    ...
    title: "Stablecoins",
    description:
      "Learn about stablecoins, the crypto assets designed to maintain stable value. Understand different types, mechanisms, and their role in the digital economy.",
    duration: "35 min",
    level: "Beginner",
    progress: 85,
    status: "Completed",
  ...
  },
  {
    ...
    title: "Tokenomics",
    description:
      "Master the economics of crypto tokens. Learn about supply mechanisms, distribution models, utility design, and how tokenomics affects project success.",
    duration: "50 min",
    level: "Intermediate",
    progress: 60,
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "Essential security practices for protecting your crypto assets. Learn about private keys, seed phrases, hardware wallets, and how to avoid common security pitfalls.",
    duration: "40 min",
    level: "Beginner",
    progress: 30,
    status: "In Progress",
...
export const mockChatResponses: Record<string, string> = {
  "liquidity-pools":
    "Liquidity pools are smart contracts that hold funds from users (liquidity providers) to enable automated trading. They use algorithms to determine prices based on the supply and demand of assets in the pool.",
  ...
  "automated-trading":
    "Automated trading in DeFi uses smart contracts and algorithms to execute trades automatically based on predefined rules, without human intervention.",
  ...
  validators:
    "Validators in PoS networks are responsible for verifying transactions and creating new blocks. They are selected based on their stake and must put their tokens at risk.",
  erc721:
    "ERC-721 is a standard for non-fungible tokens (NFTs) on Ethereum. Each token is unique and cannot be replicated.",
  erc1155:
  ...
  "yield-farming":
    "Yield farming involves lending or staking cryptocurrency to earn rewards, typically in the form of additional tokens.",
  liquidity:
    "Liquidity refers to how easily an asset can be bought or sold without affecting its price.",
  protocols:
    "DeFi protocols are applications built on blockchain that provide financial services like lending, trading, and earning yield.",
  "private-keys":
    "Private keys are secret numbers that allow you to spend cryptocurrencies. Never share them with anyone.",
  "seed-phrases":
    "Seed phrases are 12-24 word sequences that can restore your crypto wallet. Keep them safe and offline.",
  "cold-storage":
    "Cold storage keeps your private keys offline, away from internet-connected devices for maximum security.",
  layer2:
    "Layer 2 solutions are built on top of blockchains to improve scalability and reduce transaction costs.",
  optimism:
    "Optimism is a Layer 2 scaling solution for Ethereum that uses optimistic rollups to reduce gas fees.",
  arbitrum:
    "Arbitrum is another Layer 2 solution that uses optimistic rollups to make Ethereum transactions faster and cheaper.",
  general:
